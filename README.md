...
de DataScientist manejando las tecnologias y herramientnas necesarias, y también aplicando el criterio para la toma de decisiones que conducen a un resultado exitoso.
...
## 6. Video con demostración del uso de la aplicación: :movie_camera:
